...
# Comment: This function test if the data has the correct column names
...
# Comment: This function test if data has a reasonable number of rows
...
# Comment: This function test if all cols have the correct specification
...
# Comment: This function test if the amount of missing values is reasonable 
...
# Comment: This function test if the latestData has UTC-time zone
